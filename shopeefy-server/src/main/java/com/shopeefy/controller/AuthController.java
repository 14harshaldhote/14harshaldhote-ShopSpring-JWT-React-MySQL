...
import com.shopeefy.config.JwtTokenProvider;
import com.shopeefy.exception.UserException;
import com.shopeefy.modal.Cart;
import com.shopeefy.modal.User;
import com.shopeefy.repository.UserRepository;
import com.shopeefy.request.LoginRequest;
import com.shopeefy.response.AuthResponse;
import com.shopeefy.service.CartService;
import com.shopeefy.service.CustomUserDetails;
import com.shopeefy.user.domain.UserRole;
...
//			User isEmailExist = UserRepository.findByEmail(email);
			...
			AuthResponse authResponse = new AuthResponse(token, "Signup Succesfully");
...
//        return new ResponseEntity<AuthResponse>(authResponse,HttpStatus.OK);
		...
		AuthResponse authResponse = new AuthResponse(token, "Signin Succesfully");
